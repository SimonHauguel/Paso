...
There are not isomorphic (If you disagree, try implementing ~f~ and ~g~ in both cases). But, there is something we can do safely : We can obtain a bird from a fish.
